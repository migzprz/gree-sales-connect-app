                        ...
                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                <Row className="mt-1">
                                    ...
                                    <Col lg="3">
                                        <Form.Group controlId="type">
                                            ...
                                            <Form.Control as="select" name="inspection_technician_id" disabled={!formData.inspection_dateonly || !formData.inspection_time} value={formData.inspection_technician_id} onChange={(e) => handleChangeTechnician(e, 'inspection_technician_id')} required>
                            ...
                            <Row className="mt-2">
                                ...
                                <Col lg="3">
                                    <Form.Group controlId="type">
                                        <Form.Label>Assigned Technician</Form.Label>
                                        <Form.Control as="select" name="service_technician_id" disabled={!formData.service_dateonly || !formData.service_time} value={formData.service_technician_id} onChange={(e) => handleChangeTechnician(e, 'service_technician_id')} required>
                                            <option value=""> Select </option>
