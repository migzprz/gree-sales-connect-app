			...
			{loading ? (
				...
				>
					...
					<Row>
						<Col lg="8">
							<Card
								style={{ padding: "15px", borderRadius: "20px", background: "#CCDBE9" }}
							>
								<Card
									style={{ padding: "15px", borderRadius: "20px", color: "#014c91" }}
								>
									<Row>
										<Col lg="9">
											<h3>
												{React.createElement(FaUserTie, {
													size: 50,
										...
										<Col className="d-flex justify-content-end">
											<EditClientDetailsModal id={id} />{" "}
											<TransferCompanyModal
												className="ms-4"
												contact_person_id={clientData.contact_person_id}
											/>
										</Col>
									</Row>
