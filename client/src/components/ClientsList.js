                    ...
                    <Table>
                         <thead>
                            <tr>
                                ...
                                <th style={{color: '#014c91'}}>Last Transaction</th>
                                <th style={{color: '#014c91'}}>Last Transaction Date</th>
                                <th style={{color: '#014c91'}}>Transaction Status</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <React.Fragment key={quotation.id}>
                                    <tr style={{ borderRadius: '20px', padding: '10px' }}>
                                        <td style={{ color: '#014c91' }}>
                                            <Link to={`/viewclientdetails`} style={{ color: '#014c91'}}>{quotation.id}</Link>
                                        </td>
                                        ...
                                        <td style={{color: '#014c91'}}>Scheduled Installation</td>
                                        <td style={{color: '#014c91'}}>{quotation.dateGenerated}</td>
                                        <td style={{ color: '#014c91' }}>Completed</td>
                                    </tr>
                                </React.Fragment>
                            ))}
                        </tbody>
