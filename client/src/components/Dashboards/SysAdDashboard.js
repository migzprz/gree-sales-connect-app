		...
		const fetchDashboardData = async () => {
			try {
				const response = await axios.get(
					`${process.env.REACT_APP_ROOT_URL}/api/getProductCount/`,
				);
				const response2 = await axios.get(
					`${process.env.REACT_APP_ROOT_URL}/api/getServicesCount/`,
				);
				const response3 = await axios.get(
					`${process.env.REACT_APP_ROOT_URL}/api/getUsersCount/`,
				);
				const response4 = await axios.get(
					`${process.env.REACT_APP_ROOT_URL}/api/getTechniciansCount/`,
				);
