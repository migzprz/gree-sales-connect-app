			...
			if (type === "Window Type AC" || type === "Split Type AC") {
				try {
					const response = await axios.get(
						`${process.env.REACT_APP_ROOT_URL}/api/getProduct/${id}`,
					);
				...
				try {
					const response = await axios.get(
						`${process.env.REACT_APP_ROOT_URL}/api/getService/${id}`,
					);
					console.log(response.data);
					setFormData(response.data[0]);
				} catch (error) {
				...
				try {
					const response = await axios.get(
						`${process.env.REACT_APP_ROOT_URL}/api/getPart/${id}`,
					);
					console.log(response.data);
					setFormData(response.data[0]);
				} catch (error) {
		...
		if (
			...
			try {
				const postResponse = await axios.patch(
					`${process.env.REACT_APP_ROOT_URL}/api/changeProductState/${id}/0`,
				);
				console.log(postResponse);
				const postResponse2 = await axios.post(
					`${process.env.REACT_APP_ROOT_URL}/api/postProduct`,
					formData,
				);
			...
			try {
				const postResponse = await axios.patch(
					`${process.env.REACT_APP_ROOT_URL}/api/changeServiceState/${id}/0`,
				);
				console.log(postResponse);
				const postResponse2 = await axios.post(
					`${process.env.REACT_APP_ROOT_URL}/api/postService`,
					formData,
				);
				console.log(postResponse2);
				window.location.reload();
			...
			try {
				const postResponse = await axios.patch(
					`${process.env.REACT_APP_ROOT_URL}/api/changePartState/${id}/0`,
				);
				console.log(postResponse);
				const postResponse2 = await axios.post(
					`${process.env.REACT_APP_ROOT_URL}/api/postPart`,
					formData,
				);
				console.log(postResponse2);
				window.location.reload();
