		...
		if (form.checkValidity()) {
			try {
				const postReponse = await axios.patch(
					`${process.env.REACT_APP_ROOT_URL}/api/updateUserDetails/${record.login_id}`,
					editData,
				);
								...
								<Form.Group controlId="modules">
									...
									<div>
										<Form.Check
											...
											required={
												record.aftersales_access === 0 &&
												record.exec_access === 0 &&
												record.sysad_access === 0
											}
