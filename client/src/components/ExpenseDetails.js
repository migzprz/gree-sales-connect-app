							...
							>
								<CardHeader>
									<Row>
										<Col>
											Date Recorded:{" "}
											<strong> {formatDate(expenseData.date_created)} </strong>
										</Col>
									...
									<Table striped bordered style={{ color: "#014c91" }}>
										...
										<tbody>
											...
											<tr>
												...
												<td style={{ color: "#014c91" }}>
													₱{" "}
													{expenseData.totalAmount && formatNumber(expenseData.totalAmount)}
												</td>
											</tr>
										</tbody>
									</Table>
