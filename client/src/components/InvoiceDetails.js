			...
			{loading ? (
				...
				>
					...
					<Row>
						<Col lg="8">
							<Card
								style={{ borderRadius: "20px", marginTop: "20px", color: "#014c91" }}
							>
								<CardHeader style={{ textAlign: "center" }}>
									<h6>CO FENG HUANG CONDITIONING SUPPLIES</h6>
									Owned & Operated by: CO FENG HUANG INC. <br />
									#955 Quezon Avenue Santa Cruz 1104 Quezon City NCR,
									<br />
								...
								<CardBody>
									...
									<Row>
										<Col lg="8">Sold To: {client.client_name}</Col>
										<Col lg="4">
											Date: {formatDate(new Date(client.date_created))}{" "}
											{new Date(client.date_created).toLocaleTimeString([], {
												hour: "2-digit",
												minute: "2-digit",
											})}
										</Col>
									...
									<Row>
										<Col lg="8">Business Style: {client.company_name}</Col>
										<Col lg="4">TIN: {client.tin}</Col>
									</Row>
									<Row>
										<Col lg="8">Address: {client.site_address}</Col>
									</Row>
									...
									>
										<thead>
											<tr>
												<th style={{ color: "#014c91", border: "1px solid #ddd" }}>
													Quantity
												</th>
										...
										<tbody>
											...
											<tr>
												...
												>
													...
													{total
														? formatNumber(
																total -
																	quotation.reduce((sum, q) => q.totalPrice + sum, 0) * 0.12,
															)
														: "0.00"}
												</td>
											</tr>
											<tr>
												...
												>
													₱ {total ? formatNumber(total * 0.12) : "0.00"}
												</td>
											</tr>
											<tr>
												<td
					...
					<Row className="mt-3">
						...
						{type !== "view" ? (
							<Col lg="2">
								<Link
									to={`/converttosale?id=${id}${type === "add" ? `&type=add&sales=${sales}` : ""}`}
									className="btn w-100"
