                    ...
                    <Col lg="3">
                        <Card style={{padding: '15px', borderRadius: '20px', background: '#CCDBE9', height: '100%'}}>
                            ...
                            <Card style={{padding: '15px', borderRadius: '20px', color: deliveries.length > 0 ? '#014c91' : '#008000', background: deliveries.length > 0 ? '' : '#E7FFE2', height: '100%' }}>
                                <Row>
                                    <Col lg="9">
                                        <h3>{React.createElement(FaTruck, { size: 25, style: { marginRight: '5px', marginBottom: '5px'  }})}{deliveries.length > 0 && deliveries[0].is_pickup ? "Pick Up" : "Delivery"}</h3>
                                    </Col>
                                    <Col className="d-flex justify-content-end">
                                
                                        <EditServiceDetailsModal 
                                            type={deliveries.length > 0 && deliveries[0].is_pickup ? "pickup" : "delivery"} 
                                ...
                                {deliveries && deliveries.length > 0 ? (
                                    <>
                                        ...
                                        <Row>
                                            ...
                                            <Row className="mt-2">
                                                <Col>
                                                    <CompleteServiceModal type={deliveries.length > 0 && deliveries[0].is_pickup ? "pickup" : "delivery"}  id={deliveries[0].delivery_id} refId={String(detail.sales_id).padStart(4, '0')}/>
                                                </Col>
                                        </Row>
                                    </>
                                ) : (
