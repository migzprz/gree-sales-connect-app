                                    ...
                                    {currentItems.map((sales, index) => (
                                        <React.Fragment key={sales.sales_id}>
                                            <tr style={{ borderRadius: '20px', padding: '10px' }}>
                                                ...
                                                <td style={{color: sales.hasService && sales.allServicesCompleted ? '#008000' : (sales.hasService && !sales.allServicesCompleted ? '#DC6601' : '')}}>
                                                    {sales.hasService && sales.allServicesCompleted ? (<FaCheck size={20} className="me-1"/>) : (sales.hasService && !sales.allServicesCompleted ? (<FaClock size={20} className="me-1"/>) : null)}
